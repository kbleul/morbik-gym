...
const Bodypart = ({item, current_bodypart , set_current_bodypart}) => {
    ...
    return (<Stack 
        ...
        sx={{ borderTop: current_bodypart === item ? '4px solid #FF2625' : "", background: theme === "light" ? '#fff' : "#4d4d4d", borderBottomLeftRadius: '20px', width: '270px', height: '280px', cursor: 'pointer', gap: '47px'}}
